...
export default function UtilitiesServicesPage() {
  const d = serviceDetail.utilities;
    ...
    <>
      <InnerBanner
        ...
        breadcrumbs={[
          ...
          { href: "/services/utilities", label: d.title },
        ]}
      />
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <aside className="rounded-xl border border-slate-200 bg-slate-50 p-6 text-sm text-slate-700">
            <p className="font-semibold text-slate-900">Program snapshot</p>
            <p className="mt-3">
              Utilities teams run structured rounds, digital checklists, and
              management-of-change for every intervention — reducing variance between
              shifts and sites.
            </p>
          </aside>
        </div>
